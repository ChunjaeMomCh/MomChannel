                ...
                <div class="detail_area">
                    <div class="text_box">
                        <div class="input_form">
                            <form method="post" action="./edit.do" onsubmit="return validateForm(this);">
                                <input type="hidden" name="noticeNo" value="${vo.noticeNo}">
                                <div class="mb-3 mt-3">
                                    <label class="input_form_title">공지 카테고리 ${vo.noticeCategory}</label>
                                    <div class="form-check radio_opt">
                                        <input type="radio" class="form-check-input" id="radio1" name="noticeCategory" value="공지">공지
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <textarea class="form-control" rows="5" id="noticeContent" name="noticeContent" autofocus> ${vo.noticeContent} </textarea>
                                </div>
