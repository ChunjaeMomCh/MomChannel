        ...
        <nav class="header_nav">
          <div class="inner">
            <ul class="header_menu navi">
              ...
              <li><a href="${pageContext.request.contextPath}/view/post/post.do">전체 게시판</a>
                <ul class="submenu" >
                  <li><a href="#"></a></li>
                  <li><a href="#"></a></li>
                  <li><a href="#"></a></li>
              ...
              <li><a href="${pageContext.request.contextPath}/view/post/post.do">학년별 게시판</a>
                <ul class="submenu" >
              ...
              <li><a href="${pageContext.request.contextPath}/view/post/post.do">지역별 게시판</a>
                <ul class="submenu" >
