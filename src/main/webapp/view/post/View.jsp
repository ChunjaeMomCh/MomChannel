          ...
          <div class="file_list">
            ...
            <ul class="attached_file">
              <li>
                ...
                <a class="download_btn" href="javascript:void(0);" @click="if(!checkUserLoggIn()){return;}"><i class="ico download"></i></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="comments_area">
          <p class="post_type_title">댓글<span class="num" x-text="commentCount"></span></p>
          <div class="reply_list">
            <div class="reply_box">
              <div class="text_box">
                <textarea placeholder="댓글을 입력하세요." x-model="comment"></textarea>
                <a href="javascript:void(0)" class="add_btn" @click="commentSave()">확인</a>
              </div>
            </div>
            <template x-for="(item,idx) in commentList" :key="idx">
              <div class="reply">
                <template x-if="item.disabled == 'true' && item.replyComment.length > 0">
                  <div class="reple_inner">
                    ...
                    <div class="text_box">
                      <a :href="'/channel/home.html?channel_id='+item.userChannelId" class="user_name" x-text="item.userChannelName"></a>
                      <p class="reply_text">
                        삭제된 댓글 입니다.
                      </p>
                    ...
                    <div class="text_box">
                      ...
                      <div class="reply_footer">
                        <div class="reply_date">
                          <p x-text="item.createDate"></p>
                          <span class="time" x-text="item.createTime"></span>
                          <a href="#none" class="re_reply" @click="reply(idx,item.id), $('.reply').removeClass('modify_ing');">답글</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="re_reply_area">
                    <div class="reply">
                      <div class="reple_inner">
                        ...
                        <div class="text_box">
                          <a :href="'/channel/home.html?channel_id='+item.userChannelId" class="user_name" x-text="items.userChannelName"></a>
          ...
          <template x-if="totalPage.length > 0">
            <a href="#none" class="btn large gray pc_none" @click="pageIndex++,getCommentList('mobile');">더보기</a>
          </template>
        </div>
