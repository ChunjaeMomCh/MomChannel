...
<head>
  ...
  <title>쌤채널</title>
  <link rel="stylesheet" href="${path}/resources/css/post/style.css?v=1"
        type="text/css">
              ...
              <ul class="card_area">  <%-- 게시글들을 배치 --%>
                <li class="content_card">  <%-- 개별 게시글을 카드 형태로 노출 --%>
                  <a href="#">  <%-- 게시글로 이동하는 링크 --%>
                    ...
                    <div class="text_area">
                      <p class="content_name">게시글 제목</p>
                      <p class="user_name"><i></i><span>채널이름</span></p>
                    </div>
                 </a>
                  <a href="#">likes</a>  <%-- 좋아요 버튼 --%>
                  <div class="tag_area">  <%-- 게시글 태그 --%>
                    <span class="badge">지역명</span>
                    <span class="badge">학년명?</span>
                  </div>
                </li>
