...
// 게시물 목록 읽기
@WebServlet("/view/post/by-grade/list.do")
public class ListGradeController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        String postGrade = req.getParameter("grade");
        if(postGrade.equals("0"))
            postGrade=null;
        else postGrade+="학년";
        ...
        String pagingImg = BoardPage.pagingStr(totalCount, pageSize,
                blockPage, pageNum,searchField,searchWord, "/view/post/by-grade/list.do");  // 바로가기 영역 HTML 문자열
